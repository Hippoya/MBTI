...
public class enfp_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enfp_list);
        String page = "http://59.15.74.148/enfp.php";
        ...
        listView = findViewById(R.id.enfp_list);
