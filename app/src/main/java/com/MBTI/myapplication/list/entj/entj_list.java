...
public class entj_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entj_list);
        String page = "http://59.15.74.148/entj.php";
        ...
        listView = findViewById(R.id.entj_list);
