...
public class entp10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entp10);
        int n = 45;
        ...
        TextView text0 = (TextView) findViewById(R.id.text_name_entp10);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_entp10);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_entp10);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_entp10);
