...
public class esfj_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_esfj_list);
        String page = "http://59.15.74.148/esfj.php";
        ...
        listView = findViewById(R.id.esfj_list);
