...
public class esfp3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_esfp3);
        int n = 10;
        ...
        image = findViewById(R.id.image_esfp3);

        new esfp3.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_esfp3);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_esfp3);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_esfp3);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_esfp3);
