...
public class esfp5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_esfp5);
        int n = 20;
        ...
        image = findViewById(R.id.image_esfp5);

        new esfp5.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_esfp5);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_esfp5);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_esfp5);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_esfp5);
