...
public class esfp6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_esfp6);
        int n = 25;
        ...
        TextView text0 = (TextView) findViewById(R.id.text_name_esfp6);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_esfp6);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_esfp6);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_esfp6);
