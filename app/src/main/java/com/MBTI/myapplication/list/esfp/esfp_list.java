...
public class esfp_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_esfp_list);
        String page = "http://59.15.74.148/esfp.php";
        ...
        listView = findViewById(R.id.esfp_list);
