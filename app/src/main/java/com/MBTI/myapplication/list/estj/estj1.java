...
public class estj1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estj1);
        int n = 0;
        ...
        image = findViewById(R.id.image_estj1);

        new estj1.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_estj1);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_estj1);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_estj1);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_estj1);
