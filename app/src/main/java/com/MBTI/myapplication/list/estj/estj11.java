package com.MBTI.myapplication.list.estj;
...
public class estj11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estj11);
        int n = 50;
        ...
        image = findViewById(R.id.image_estj11);

        new estj11.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_estj11);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_estj11);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_estj11);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_estj11);
