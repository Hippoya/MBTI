...
public class estj2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estj2);
        int n = 5;
        ...
        image = findViewById(R.id.image_estj2);

        new estj2.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_estj2);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_estj2);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_estj2);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_estj2);
