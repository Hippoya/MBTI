...
public class estj5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estj5);
        int n = 20;
        ...
        image = findViewById(R.id.image_estj5);

        new estj5.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_estj5);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_estj5);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_estj5);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_estj5);
