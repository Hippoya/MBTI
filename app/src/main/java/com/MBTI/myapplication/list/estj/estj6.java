...
public class estj6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estj6);
        int n = 25;
        ...
        image = findViewById(R.id.image_estj6);

        new estj6.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_estj6);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_estj6);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_estj6);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_estj6);
