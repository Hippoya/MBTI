...
public class estj_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estj_list);
        String page = "http://59.15.74.148/estj.php";
        ...
        listView = findViewById(R.id.estj_list);
