...
public class estp10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estp10);
        int n = 45;
        ...
        image = findViewById(R.id.image_estp10);

        new estp10.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_estp10);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_estp10);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_estp10);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_estp10);
