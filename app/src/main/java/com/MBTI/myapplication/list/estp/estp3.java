...
public class estp3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estp3);
        int n = 10;
        ...
        image = findViewById(R.id.image_estp3);

        new estp3.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_estp3);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_estp3);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_estp3);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_estp3);
