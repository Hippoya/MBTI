...
public class estp4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estp4);
        int n = 15;
        ...
        image = findViewById(R.id.image_estp4);

        new estp4.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_estp4);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_estp4);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_estp4);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_estp4);
