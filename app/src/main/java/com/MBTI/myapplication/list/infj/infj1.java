...
public class infj1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView text0 = (TextView) findViewById(R.id.text_name_infj1);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_infj1);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_infj1);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_infj1);
