package com.MBTI.myapplication.list.infj;
...
public class infj10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_infj10);
        int n = 45;
        ...
        image = findViewById(R.id.image_infj10);

        new infj10.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_infj10);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_infj10);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_infj10);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_infj10);
