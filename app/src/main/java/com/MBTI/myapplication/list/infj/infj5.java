...
public class infj5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_infj5);
        int n = 20;
        ...
        image = findViewById(R.id.image_infj5);

        new infj5.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_infj5);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_infj5);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_infj5);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_infj5);
