...
public class infj7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_infj7);
        int n = 30;

        Intent intent = getIntent();
        ArrayList<String> info = (ArrayList<String>)intent.getSerializableExtra("sVal");

        image = findViewById(R.id.image_infj7);

        new infj7.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_infj7);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_infj7);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_infj7);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_infj7);
