...
public class infj8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_infj8);
        int n = 35;

        Intent intent = getIntent();
        ArrayList<String> info = (ArrayList<String>)intent.getSerializableExtra("sVal");

        image = findViewById(R.id.image_infj8);

        new infj8.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_infj8);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_infj8);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_infj8);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_infj8);
