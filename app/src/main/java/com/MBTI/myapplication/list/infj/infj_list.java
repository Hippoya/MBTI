...
public class infj_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_infj_list);
        String page = "http://59.15.74.148/infj.php";
        ...
        listView = findViewById(R.id.infj_list);
