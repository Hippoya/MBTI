...
public class infp2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_infp2);
        int n = 5;

        Intent intent = getIntent();
        ArrayList<String> info = (ArrayList<String>)intent.getSerializableExtra("sVal");

        image = findViewById(R.id.image_infp2);

        new infp2.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_infp2);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_infp2);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_infp2);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_infp2);
