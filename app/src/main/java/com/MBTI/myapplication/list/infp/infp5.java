...
public class infp5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_infp5);
        int n = 20;
        ...
        image = findViewById(R.id.image_infp5);

        new infp5.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_infp5);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_infp5);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_infp5);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_infp5);
