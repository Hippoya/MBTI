...
public class infp7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_infp7);
        int n = 30;
        ...
        image = findViewById(R.id.image_infp7);

        new infp7.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_infp7);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_infp7);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_infp7);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_infp7);
