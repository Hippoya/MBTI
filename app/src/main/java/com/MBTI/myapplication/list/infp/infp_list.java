...
public class infp_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_infp_list);

        String page = "http://59.15.74.148/infp.php";
        ...
        listView = findViewById(R.id.infp_list);
