...
public class intj5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intj5);
        int n = 20;
        ...
        TextView text0 = (TextView) findViewById(R.id.text_name_intj5);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_intj5);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_intj5);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_intj5);
