...
public class intp8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intp8);
        int n = 35;
        ...
        TextView text0 = (TextView) findViewById(R.id.text_name_intp8);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_intp8);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_intp8);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_intp8);
