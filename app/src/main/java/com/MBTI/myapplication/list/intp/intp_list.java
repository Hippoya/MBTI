...
public class intp_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intp_list);
        String page = "http://59.15.74.148/intp.php";
        ...
        listView = findViewById(R.id.intp_list);
