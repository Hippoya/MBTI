...
public class isfj8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_isfj8);
        int n = 35;
        ...
        TextView text0 = (TextView) findViewById(R.id.text_name_isfj8);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_isfj8);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_isfj8);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_isfj8);
