...
public class isfj_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_isfj_list);
        String page = "http://59.15.74.148/isfj.php";
        ...
        listView = findViewById(R.id.isfj_list);
