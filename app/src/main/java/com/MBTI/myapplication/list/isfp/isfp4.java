...
public class isfp4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_isfp4);
        int n = 15;
        ...
        TextView text0 = (TextView) findViewById(R.id.text_name_isfp4);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_isfp4);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_isfp4);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_isfp4);
