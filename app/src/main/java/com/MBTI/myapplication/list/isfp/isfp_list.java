...
public class isfp_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_isfp_list);
        String page = "http://59.15.74.148/isfp.php";
        ...
        listView = findViewById(R.id.isfp_list);
