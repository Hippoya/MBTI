...
public class istj10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_istj10);
        int n = 45;

        Intent intent = getIntent();
        ArrayList<String> info = (ArrayList<String>)intent.getSerializableExtra("sVal");

        image = findViewById(R.id.image_istj10);

        new istj10.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_istj10);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_istj10);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_istj10);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_istj10);
