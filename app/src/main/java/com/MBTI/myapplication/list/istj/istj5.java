...
public class istj5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_istj5);
        int n = 20;

        Intent intent = getIntent();
        ArrayList<String> info = (ArrayList<String>)intent.getSerializableExtra("sVal");

        image = findViewById(R.id.image_istj5);

        new istj5.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_istj5);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_istj5);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_istj5);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_istj5);
