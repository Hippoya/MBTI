...
public class istj7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_istj7);
        int n = 30;
        ...
        TextView text0 = (TextView) findViewById(R.id.text_name_istj7);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_istj7);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_istj7);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_istj7);
