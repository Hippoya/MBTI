...
public class istj8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_istj8);
        int n = 35;
        ...
        image = findViewById(R.id.image_istj8);

        new istj8.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_istj8);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_istj8);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_istj8);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_istj8);
