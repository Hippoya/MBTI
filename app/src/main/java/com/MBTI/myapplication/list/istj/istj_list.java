...
public class istj_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_istj_list);
        String page = "http://59.15.74.148/istj.php";
        ...
        listView = findViewById(R.id.istj_list);
