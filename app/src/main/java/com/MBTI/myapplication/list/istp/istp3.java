...
public class istp3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_istp3);
        int n = 10;

        Intent intent = getIntent();
        ArrayList<String> info = (ArrayList<String>)intent.getSerializableExtra("sVal");

        image = findViewById(R.id.image_istp3);

        new istp3.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_istp3);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_istp3);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_istp3);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_istp3);
