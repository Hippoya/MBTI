...
public class istp4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_istp4);
        int n = 15;
        ...
        TextView text0 = (TextView) findViewById(R.id.text_name_istp4);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_istp4);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_istp4);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_istp4);
