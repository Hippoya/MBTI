...
public class istp6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_istp6);
        int n = 25;
        ...
        image = findViewById(R.id.image_istp6);

        new istp6.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_istp6);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_istp6);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_istp6);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_istp6);
