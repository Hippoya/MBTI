...
public class istp7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_istp7);
        int n = 30;
        ...
        image = findViewById(R.id.image_istp7);

        new istp7.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_istp7);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_istp7);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_istp7);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_istp7);
