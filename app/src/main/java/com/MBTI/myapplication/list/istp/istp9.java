...
public class istp9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_istp9);
        int n = 40;
        ...
        image = findViewById(R.id.image_istp9);

        new istp9.DownloadFilesTask().execute(info.get(1+n));

        TextView text0 = (TextView) findViewById(R.id.text_name_istp9);
        text0.setText(info.get(0+n));

        TextView text1 = (TextView) findViewById(R.id.text_address_istp9);
        text1.setText(info.get(2+n));

        TextView text2 = (TextView) findViewById(R.id.text_istp9);
        text2.setText(info.get(3+n));

        Button btn1 = (Button) findViewById(R.id.btn_istp9);
