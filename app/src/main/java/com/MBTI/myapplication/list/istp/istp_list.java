...
public class istp_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_istp_list);
        String page = "http://59.15.74.148/istp.php";
        ...
        listView = findViewById(R.id.istp_list);
