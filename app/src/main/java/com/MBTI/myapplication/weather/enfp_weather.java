...
public class enfp_weather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enfp_weather);

        weather_text = (TextView)findViewById(R.id.text2_enfp_weather);
