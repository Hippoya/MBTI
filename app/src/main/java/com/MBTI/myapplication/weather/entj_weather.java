...
public class entj_weather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entj_weather);

        weather_text = (TextView)findViewById(R.id.text2_entj_weather);
