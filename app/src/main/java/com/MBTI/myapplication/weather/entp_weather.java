...
public class entp_weather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entp_weather);

        weather_text = (TextView)findViewById(R.id.text2_entp_weather);
