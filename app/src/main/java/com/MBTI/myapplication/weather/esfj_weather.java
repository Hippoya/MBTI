...
public class esfj_weather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_esfj_weather);

        weather_text = (TextView)findViewById(R.id.text2_esfj_weather);
