...
public class esfp_weather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_esfp_weather);

        weather_text = (TextView)findViewById(R.id.text2_esfp_weather);
