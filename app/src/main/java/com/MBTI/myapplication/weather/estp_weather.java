...
public class estp_weather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estp_weather);

        weather_text = (TextView)findViewById(R.id.text2_estp_weather);
