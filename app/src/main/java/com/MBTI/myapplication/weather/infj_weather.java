...
public class infj_weather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_infj_weather);

        weather_text = (TextView)findViewById(R.id.text2_infj_weather);
