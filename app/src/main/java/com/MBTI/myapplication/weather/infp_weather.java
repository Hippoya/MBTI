...
public class infp_weather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_infp_weather);

        weather_text = (TextView)findViewById(R.id.text2_infp_weather);
