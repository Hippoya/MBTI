...
public class isfj_weather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_isfj_weather);

        weather_text = (TextView)findViewById(R.id.text2_isfj_weather);
