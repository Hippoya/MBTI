...
public class isfp_weather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_isfp_weather);

        weather_text = (TextView)findViewById(R.id.text2_isfp_weather);
