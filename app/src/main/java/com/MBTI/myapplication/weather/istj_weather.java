...
public class istj_weather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_istj_weather);

        weather_text = (TextView)findViewById(R.id.text2_istj_weather);
