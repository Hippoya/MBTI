...
public class istp_weather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_istp_weather);

        weather_text = (TextView)findViewById(R.id.text2_istp_weather);
